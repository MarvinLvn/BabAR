<p align="center">
  <img src="docs/BabAR_logo.png" alt="BabAR logo" width="300">
</p>
...
- [Installation](docs/installation.md) — System requirements, cloning, and dependency setup
- [Usage](docs/usage.md) — Running the pipeline, available options, and output formats
- [Running time](docs/running_time.md) — Timing information and performance tips
